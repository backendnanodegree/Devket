# Generated by Django 3.2.13 on 2022-11-05 15:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.IntegerField(choices=[{1, '결제'}, {0, '미결제'}], default=0, verbose_name='결제상태')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.IntegerField(choices=[{1, '신용카드'}], verbose_name='결제방식')),
                ...
                ('status', models.IntegerField(choices=[{'결제완료', 2}, {1, '결제대기'}, {0, '결제취소'}], default=1, verbose_name='결제상태')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authentication_check', models.IntegerField(choices=[{'인증', 1}, {0, '미인증'}], default=0, verbose_name='이메일 인증 여부')),
