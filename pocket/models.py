...
class Highlight(models.Model):
    ...
    list = models.ForeignKey(List, on_delete=models.CASCADE, verbose_name='리스트', null=True)
    content_location = models.JSONField(verbose_name='컨텐츠', default=dict)
    content_text = models.TextField(verbose_name='하이라이트문구')
